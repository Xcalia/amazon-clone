...
export const Order = ({ id, amount, amountShipping, items, timestamp, images }) => {
    return (
        <div className='border relative rounded-md'>
            <div className='flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600'>
                ...
                <p className='absolute top-2 right-0 w-40 lg:w-72 truncate text-xs whitespace-nowrap'>ORDER # {id}</p>
            </div>
